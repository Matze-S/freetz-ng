...
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_LIB_liblua_WITH_FLOAT),$(if $(FREETZ_LIB_liblua_WITH_VERSION_ABANDON),abandon,current)/float)
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_LIB_liblua_WITH_FLOAT
