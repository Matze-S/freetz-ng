$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.9,2.6.6)))
...
$(PKG)_HASH_26:=3b074f392818b31aa529b84f76e8b5e4ad03fca764924f46d906bceaaf421034
