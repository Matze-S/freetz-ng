$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_OPENVPN_VERSION_24),2.4.12,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_25),2.5.11,$(if $(FREETZ_PACKAGE_OPENVPN_VERSION_26),2.6.20,2.7.4))))
...
$(PKG)_HASH_27:=18db05f3d5eee3663db1914590044e5f96ff5cd47b6e7846c6a350806c23dbce
